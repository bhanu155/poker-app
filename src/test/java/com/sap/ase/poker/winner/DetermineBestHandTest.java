...
import com.sap.ase.poker.winner.DetermineBestHand.Result;
...
public class DetermineBestHandTest {
	...
	public void duplicateCards() throws Exception {
		try {
			new DetermineBestHand().execute(CLUBS_2, CLUBS_2, DIAMONDS_10, DIAMONDS_8, DIAMONDS_9, SPADES_JACK,
					SPADES_QUEEN);
		...
		try {
			new DetermineBestHand().execute(CLUBS_2, CLUBS_4, DIAMONDS_10, CLUBS_4, DIAMONDS_9, SPADES_JACK,
					SPADES_QUEEN);
	...
	public void highCard() throws Exception {
		Result result = new DetermineBestHand().execute(CLUBS_2, CLUBS_4, SPADES_KING, DIAMONDS_10, DIAMONDS_8,
	...
	public void pair() throws Exception {
		Result result = new DetermineBestHand().execute(CLUBS_2, CLUBS_4, SPADES_QUEEN, DIAMONDS_10, SPADES_4,
				DIAMONDS_9, SPADES_JACK);
	...
	public void twoPairs_outOfThree() throws Exception {
		Result result = new DetermineBestHand().execute(SPADES_4, CLUBS_4, SPADES_QUEEN, DIAMONDS_10, SPADES_10,
				DIAMONDS_QUEEN, SPADES_JACK);
		assertEquals(TWO_PAIRS, result.handType);
	...
	public void threeOfAKind() throws Exception {
		Result result = new DetermineBestHand().execute(CLUBS_2, CLUBS_4, SPADES_QUEEN, DIAMONDS_10, SPADES_4, HEARTS_4,
				SPADES_JACK);
	...
	public void threeOfAKind_outOfTwo() throws Exception {
		Result result = new DetermineBestHand().execute(CLUBS_2, CLUBS_4, SPADES_QUEEN, DIAMONDS_QUEEN, SPADES_4,
	...
	public void fourOfAKind() throws Exception {
		Result result = new DetermineBestHand().execute(CLUBS_2, CLUBS_4, DIAMONDS_4, DIAMONDS_10, SPADES_4, HEARTS_4,
				SPADES_JACK);
	...
	public void fullHouse() throws Exception {
		Result result = new DetermineBestHand().execute(CLUBS_2, CLUBS_4, DIAMONDS_4, DIAMONDS_QUEEN, SPADES_4,
	...
	public void straight() throws Exception {
		Result result = new DetermineBestHand().execute(CLUBS_4, DIAMONDS_10, DIAMONDS_8, DIAMONDS_9, SPADES_JACK,
	...
	public void straightWithPair() throws Exception {
		Result result = new DetermineBestHand().execute(SPADES_KING, DIAMONDS_10, DIAMONDS_8, DIAMONDS_9, SPADES_JACK,
				SPADES_QUEEN, DIAMONDS_KING);
		assertEquals(STRAIGHT, result.handType);
	...
	public void falseStraight() throws Exception {
		Result result = new DetermineBestHand().execute(CLUBS_4, CLUBS_2, DIAMONDS_8, DIAMONDS_ACE, SPADES_JACK,
				SPADES_QUEEN, DIAMONDS_KING);
		assertEquals(HIGH_CARD, result.handType);
	...
	public void smallStraight() throws Exception {
		Result result = new DetermineBestHand().execute(CLUBS_3, CLUBS_2, DIAMONDS_4, DIAMONDS_ACE, SPADES_5,
				SPADES_QUEEN, DIAMONDS_KING);
		assertEquals(STRAIGHT, result.handType);
	...
	public void flush() throws Exception {
		Result result = new DetermineBestHand().execute(CLUBS_4, DIAMONDS_9, DIAMONDS_4, DIAMONDS_8, DIAMONDS_10,
	...
	public void smallStraightFlush() throws Exception {
		Result result = new DetermineBestHand().execute(DIAMONDS_2, DIAMONDS_ACE, DIAMONDS_4, DIAMONDS_3, DIAMONDS_5,
				DIAMONDS_QUEEN, DIAMONDS_JACK);
		assertEquals(STRAIGHT_FLUSH, result.handType);
	...
	public void royalFlush() throws Exception {
		Result result = new DetermineBestHand().execute(CLUBS_4, DIAMONDS_9, DIAMONDS_ACE, DIAMONDS_KING, DIAMONDS_10,
				DIAMONDS_QUEEN, DIAMONDS_JACK);
