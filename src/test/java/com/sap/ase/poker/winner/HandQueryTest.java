...
public class HandQueryTest {
	...
	public void illegalNumberOfCards() throws Exception {
		try {
			new HandQuery().findBestHand();
			fail("0 cards should be illegal for hand evaluation");
		} catch (IllegalNumberOfCards e) {
			assertEquals(0, e.numberOfCards);
		}
		try {
			new HandQuery().findBestHand(CLUBS_2, CLUBS_3, CLUBS_4, CLUBS_5, CLUBS_6, CLUBS_7);
			fail("6 cards should be illegal for hand evaluation");
		} catch (IllegalNumberOfCards e) {
			assertEquals(6, e.numberOfCards);
		}
		try {
			new HandQuery().findBestHand(CLUBS_2, CLUBS_3, CLUBS_4, CLUBS_5, CLUBS_6, CLUBS_7, CLUBS_8, CLUBS_9);
	...
	public void duplicateCards() throws Exception {
		try {
			new HandQuery().findBestHand(CLUBS_2, new Card(TWO, CLUBS), CLUBS_3, CLUBS_4, CLUBS_5, CLUBS_6, CLUBS_7);
			fail("duplicate cards should be illegal for hand evaluation");
		} catch (DuplicateCards e) {
			assertEquals(CLUBS_2, e.duplicateCard);
		}
		try {
			new HandQuery().findBestHand(CLUBS_2, CLUBS_3, CLUBS_2, CLUBS_4, CLUBS_5, CLUBS_6, CLUBS_7);
			fail("duplicate cards should be illegal for hand evaluation");
		} catch (DuplicateCards e) {
			assertEquals(CLUBS_2, e.duplicateCard);
		}
		try {
			new HandQuery().findBestHand(CLUBS_2, CLUBS_7, CLUBS_3, CLUBS_4, CLUBS_5, CLUBS_6, CLUBS_7);
			fail("duplicate cards should be illegal for hand evaluation");
		} catch (DuplicateCards e) {
	...
	public void highCard() throws Exception {
		Hand result = new HandQuery().findBestHand(CLUBS_2, CLUBS_4, SPADES_KING, DIAMONDS_10, DIAMONDS_8, DIAMONDS_9,
				SPADES_JACK);
	...
	public void pair() throws Exception {
		Hand result = new HandQuery().findBestHand(CLUBS_2, CLUBS_4, SPADES_QUEEN, DIAMONDS_10, SPADES_4, DIAMONDS_9,
				SPADES_JACK);
	...
	public void twoPairs() throws Exception {
		Hand result = new HandQuery().findBestHand(CLUBS_2, CLUBS_4, SPADES_QUEEN, DIAMONDS_10, SPADES_4, DIAMONDS_QUEEN,
				SPADES_JACK);
	...
	public void twoPairs_outOfThree() throws Exception {
		Hand result = new HandQuery().findBestHand(SPADES_4, CLUBS_4, SPADES_QUEEN, DIAMONDS_10, SPADES_10,
	...
	public void threeOfAKind() throws Exception {
		Hand result = new HandQuery().findBestHand(CLUBS_2, CLUBS_4, SPADES_QUEEN, DIAMONDS_10, SPADES_4, HEARTS_4,
				SPADES_JACK);
	...
	public void fourOfAKind() throws Exception {
		Hand result = new HandQuery().findBestHand(CLUBS_2, CLUBS_4, DIAMONDS_4, DIAMONDS_10, SPADES_4, HEARTS_4,
				SPADES_JACK);
	...
	public void fullHouse() throws Exception {
		Hand result = new HandQuery().findBestHand(CLUBS_2, CLUBS_4, DIAMONDS_4, DIAMONDS_QUEEN, SPADES_4, SPADES_QUEEN,
				SPADES_JACK);
	...
	public void fullHouse_twoThreeOfAKind() throws Exception {
		Hand result = new HandQuery().findBestHand(CLUBS_2, CLUBS_4, SPADES_QUEEN, DIAMONDS_QUEEN, SPADES_4, HEARTS_4,
				CLUBS_QUEEN);
		assertEquals(FULL_HOUSE, result.type);
	...
	public void straight() throws Exception {
		Hand result = new HandQuery().findBestHand(CLUBS_4, DIAMONDS_10, DIAMONDS_8, DIAMONDS_9, SPADES_JACK,
	...
	public void straightWithPair() throws Exception {
		Hand result = new HandQuery().findBestHand(SPADES_KING, DIAMONDS_10, DIAMONDS_8, DIAMONDS_9, SPADES_JACK,
				SPADES_QUEEN, DIAMONDS_KING);
		assertEquals(STRAIGHT, result.type);
	...
	public void falseStraight() throws Exception {
		Hand result = new HandQuery().findBestHand(CLUBS_4, CLUBS_2, DIAMONDS_8, DIAMONDS_ACE, SPADES_JACK, SPADES_QUEEN,
				DIAMONDS_KING);
		assertEquals(HIGH_CARD, result.type);
	...
	public void smallStraight() throws Exception {
		Hand result = new HandQuery().findBestHand(CLUBS_3, CLUBS_2, DIAMONDS_4, DIAMONDS_ACE, SPADES_5, SPADES_QUEEN,
				DIAMONDS_KING);
		assertEquals(STRAIGHT, result.type);
	...
	public void flush() throws Exception {
		Hand result = new HandQuery().findBestHand(CLUBS_4, DIAMONDS_9, DIAMONDS_4, DIAMONDS_8, DIAMONDS_10,
	...
	public void smallStraightFlush() throws Exception {
		Hand result = new HandQuery().findBestHand(DIAMONDS_2, DIAMONDS_ACE, DIAMONDS_4, DIAMONDS_3, DIAMONDS_5,
				DIAMONDS_QUEEN, DIAMONDS_JACK);
		assertEquals(STRAIGHT_FLUSH, result.type);
	...
	public void royalFlush() throws Exception {
		Hand result = new HandQuery().findBestHand(CLUBS_4, DIAMONDS_9, DIAMONDS_ACE, DIAMONDS_KING, DIAMONDS_10,
				DIAMONDS_QUEEN, DIAMONDS_JACK);
